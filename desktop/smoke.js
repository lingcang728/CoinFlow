// CoinFlow Electron smoke test（从 main.js 抽离）。
// 仅在 COINFLOW_SMOKE_TEST=1 时由 main.js 调用：npm run smoke:desktop
...
// 须在 app ready 之前调用：调整渲染开关与临时 userData，避免污染真实账本。
function setupSmokeEnvironment() {
